...
import com.rms.utility.base.util.NumberUtil;
 ...
 * @since 2015/08/31
 */
class DefaultJDBCQueryResultMetaData implements QueryResultMetaData {

	private final Logger logger = Logger.getLogger(DefaultJDBCQueryResultMetaData.class);
