...
import com.yyfs.dev.utility.xml.node.build.AttributeBuilder;
import com.yyfs.dev.utility.xml.node.build.DocumentBuilder;
import com.yyfs.dev.utility.xml.node.build.DocumentTypeBuilder;
import com.yyfs.dev.utility.xml.node.build.ElementBuilder;
import com.yyfs.dev.utility.xml.node.build.NodeBuilderFactory;
import com.yyfs.dev.utility.xml.node.build.TextBuilder;
 ...
 * @since 2014/01/21
 */
class NodeConvertorImpl implements NodeConvertor {
	...
	public DocumentNode convert(Document document) {
		...
		DocumentNode documentNode = documentBuilder// documentNode define
