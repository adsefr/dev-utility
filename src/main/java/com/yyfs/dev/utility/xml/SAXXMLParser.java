...
class Handler extends DefaultHandler2 {
	...
	private void append(String text) {
		...
		builder.append(text).append(StringConst.SYSTEM_LINE_SEPARATOR);
	}
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
		...
		append("start:" + start + " length:" + length + " content:" + new String(Arrays.copyOfRange(ch, start, start + length)));
	}
