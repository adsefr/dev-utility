...
import com.yyfs.dev.utility.poi.excel.model.CellAreaModel;
import com.yyfs.dev.utility.poi.excel.model.CellModel;
...
public interface SheetObject {
	 ...
	 * 現在列位置を設定する。<br>
	 * currColumnIndex
	 * <0の場合やcurrColumnIndex> {@code CellCreator.getMaxColumnIndex()}
	...
	void setExcelObject(ExcelObject excelObject);
